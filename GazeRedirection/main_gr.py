...
parser.add_argument(
    "--adam_beta1", type=float, default=0.5, help="value of adam beta 1"
)
parser.add_argument(
    "--adam_beta2", type=float, default=0.999, help="value of adam beta 2"
)
parser.add_argument("--lr", type=float, default=0.0002, help="learning rate")

# training params
parser.add_argument("--epochs", type=int, default=300, help="number of epochs")
parser.add_argument("--summary_steps", type=int, default=500, help="summary steps")

# dataset params
parser.add_argument("--image_size", type=int, default=64, help="size of cropped images")
parser.add_argument(
    "--ids", type=int, default=0, help="number of identities for training"
)
parser.add_argument(
    "--fold_size", type=int, default=3, help="size of one validation fold"
)
parser.add_argument(
    "--n_people", type=int, default=56, help="number of cross validation folds"
)
