...
class CheckpointManager(object):
    ...
    def build_savers(self):
        ...
        for prefix in all_prefixes:
            vars_to_save = [
                v for v in all_saveable_vars if v.name.startswith(prefix + "/")
            ]
            if len(vars_to_save):
